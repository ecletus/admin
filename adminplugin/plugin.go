...
func (p *Plugin) OnRegister() {
	p.On(plug.E_POST_INIT, func(e plug.PluginEventInterface) (err error) {
		...
		return admins.Each(func(adminName string, Admin *admin.Admin) (err error) {
			log.Debugf("[admin=%q] trigger AdminEvent", adminName)
			...
			log.Debugf("[admin=%q] trigger AdminInitResourcesEvent", adminName)
			...
			log.Debugf("[admin=%q] trigger AdminFuncMapEvent", adminName)
			...
			log.Debugf("[admin=%q] trigger AdminDone", adminName)
